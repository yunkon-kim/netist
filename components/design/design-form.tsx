...
import { cspRegions, CSP, NetworkConfig, VNetConfig } from "@/types/types";
import styles from "@/styles/design/design.module.css";
import VNetForm from "./vnet-form";
  ...
  return (
    <div className={styles.containerFluid}>
      <aside className={styles.sidebar}>
        <h3 className={styles.title}>Design! your multi-cloud network 😉</h3>
        ...
        <div className={styles.formGroup}>
          ...
          <select
            ...
            onChange={(e) => {
              ...
              setSelectedRegion(cspRegions[newCsp][0]);
            }}
          >
            {Object.keys(cspRegions).map((csp) => (
        ...
        <div className={styles.formGroup}>
          ...
          >
            {cspRegions[selectedCsp].map((region) => (
